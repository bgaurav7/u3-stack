...
// Example: import { healthRouter } from '~/routers/health';
// Example: import { todoRouter } from '~/routers/todo';
...
/**
 * Placeholder app router - will be populated with feature routers in later tasks
 * This will be updated when health, todo, auth, and user routers are implemented
 */
export const appRouter = createAppRouter({
  // Feature routers will be added here in later tasks:
  // health: healthRouter,
  // todo: todoRouter,
  // auth: authRouter,
  // user: userRouter,
